...
class HomeIndex extends React.Component {
    ...
    render() {
        const siteTitle = "Mark McCulloh"
        const siteDescription = "Mark's Site"
                ...
                <div id="main">
                    ...
                    <section id="one">
                        <header className="major">
                            <h2>WIP Portfolio Site</h2>
                        </header>
                        <p>I decided to replace the lorem ipsum with less useful text</p>
                        <ul className="actions">
                            <li><a href="/test" className="button">Test</a></li>
                        </ul>
                    </section>

{/*                     <section id="two">
                        <h2>If I were a photographer, this would be my recent work</h2>
